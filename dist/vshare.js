! function(e, t) {
  "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define &&
    define.amd ? define("vshare", [], t) : "object" == typeof exports ? exports.vshare = t() : e.vshare = t()
  ...
  return function(e) {
    ...
    r.a.install = function(e) {
      e.component("vshare", r.a), "undefined" != typeof window && window.Vue && window.Vue.use(r.a)
    }, t.default = r.a
  }, function(e, t, n) {
    "use strict";
    ...
    e.exports = function(e) {
      ...
      return t.toString = function() {
        ...
        for (o = 0; o < e.length; o++) {
          var i = e[o];
          "number" == typeof i[0] && r[i[0]] || (n && !i[2] ? i[2] = n : n && (i[2] = "(" + i[2] +
            ") and (" + n + ")"), t.push(i))
        }
      }, t
    }
    ...
    function s(e) {
      ...
      if (y) {
        var s = l++;
        r = p || (p = o()), t = i.bind(null, r, s, !1), n = i.bind(null, r, s, !0)
    ...
    function a(e, t) {
      ...
      if (r && e.setAttribute("media", r), m.ssrId && e.setAttribute(g, t.id), o && (n += "\n/*# sourceURL=" +
          o.sources[0] + " */", n += "\n/*# sourceMappingURL=data:application/json;base64," + btoa(unescape(
            encodeURIComponent(JSON.stringify(o)))) + " */"), e.styleSheet) e.styleSheet.cssText = n;
      else {
    ...
    if ("undefined" != typeof DEBUG && DEBUG && !u) throw new Error(
    ...
    e.exports = function(e, t, n, r, o, s) {
      ...
      t && (c.render = t.render, c.staticRenderFns = t.staticRenderFns, c._compiled = !0), n && (c.functional = !
        0), o && (c._scopeId = o);
      var f;
      if (s ? (f = function(e) {
          e = e || this.$vnode && this.$vnode.ssrContext || this.parent && this.parent.$vnode && this.parent
            .$vnode.ssrContext, e || "undefined" == typeof __VUE_SSR_CONTEXT__ || (e = __VUE_SSR_CONTEXT__),
            r && r.call(this, e), e && e._registeredComponents && e._registeredComponents.add(s)
    ...
    var r = function() {
        ...
        return n("div", [n("input", {
          ...
          on: {
            input: function(t) {
              t.target.composing || (e.vshareText = t.target.value)
            }
          }
        }), e._v(" "), n("div", [e._v("你输入的是：" + e._s(e.vshareText))])])
      },
      o = [],
      s = {
        render: r,
...
//# sourceMappingURL=vshare.js.map
